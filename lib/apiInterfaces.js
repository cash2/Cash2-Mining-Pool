...
/**
 * Send Daemon RPC request
 **/
function rpcDaemon(host, port, method, params, callback){
...
/**
 * Send Walletd RPC request
 **/
function rpcWallet(host, port, method, params, callback){
    var data = JSON.stringify({
        id: "0",
        jsonrpc: "2.0",
        password: config.wallet.rpcPassword,
        method: method,
        params: params
    });
    jsonHttpRequest(host, port, data, function(error, replyJson){
...
module.exports = function(daemonConfig, walletConfig, poolApiConfig){
    return {
        ...
        rpcDaemon: function(method, params, callback){
            rpcDaemon(daemonConfig.host, daemonConfig.port, method, params, callback);
        },
        rpcWallet: function(method, params, callback){
            rpcWallet(walletConfig.host, walletConfig.port, method, params, callback);
        },
