...
function sendPoolStats(chatId) {
    apiInterfaces.pool('/stats', function(error, stats) {    
        ...
        var networkHashrate = utils.getReadableHashRate(difficulty / stats.config.coinDifficultyTarget);
        var networkDiff = difficulty || 'N/A';
        ...
        var currentEffort = stats.pool.roundHashes ? (stats.pool.roundHashes / difficulty * 100).toFixed(1) + '%' : '0%';
